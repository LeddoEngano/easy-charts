  ...
  },
  {
    ...
    preview: (
      <div
        ...
        style={{
          background:
            "repeating-linear-gradient(to right, currentColor 0, currentColor 10px, transparent 10px, transparent 15px)",
        }}
      />
    ),
  },
  ...
  },
  {
    ...
    preview: (
      <div
        ...
        style={{
          background:
            "repeating-linear-gradient(to right, currentColor 0, currentColor 10px, transparent 10px, transparent 13px, currentColor 13px, currentColor 16px, transparent 16px, transparent 21px)",
        }}
      />
    ),
  },
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <input
              ...
              onMouseEnter={(e) => {
                if (
                  /^#[0-9A-Fa-f]{6}$/.test((e.target as HTMLInputElement).value)
                ) {
                  onPreviewColor((e.target as HTMLInputElement).value);
                }
              }}
